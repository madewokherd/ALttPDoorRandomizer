...
def create_regions(world, player):
    world.regions += [
        create_menu_region(player, 'Menu', None, ['Links House S&Q', 'Sanctuary S&Q', 'Old Man S&Q', 'Dark Sanctuary S&Q', 'Castle Ledge S&Q']),
        create_menu_region(player, 'Flute Sky', None, ['Flute Spot 1', 'Flute Spot 2', 'Flute Spot 3', 'Flute Spot 4',
                                                        ...
                                                        'Inverted Flute Spot 1', 'Inverted Flute Spot 2', 'Inverted Flute Spot 3',
                                                        'Inverted Flute Spot 4', 'Inverted Flute Spot 5', 'Inverted Flute Spot 6',
                                                        'Inverted Flute Spot 7', 'Inverted Flute Spot 8']),
        ...
        create_lw_region(player, 'Kakariko Area', ['Bottle Merchant'], ['Kakariko Southwest Bush (North)', 'Kakariko Yard Bush (South)', 'Kakariko Well Drop', 'Kakariko Well Cave', 'Blinds Hideout', 'Elder House (West)', 'Elder House (East)',
                        'Snitch Lady (West)', 'Snitch Lady (East)', 'Chicken House', 'Sick Kids House',
        ...
        create_lw_region(player, 'Hyrule Castle Courtyard', None, ['Hyrule Castle Courtyard Bush (South)', 'Inverted Pyramid Entrance', 'Hyrule Castle Entrance (South)', 'Hyrule Castle Main Gate (North)', 'Top of Pyramid (Inner)']),
        ...
        create_lw_region(player, 'Hyrule Castle Ledge', None, ['Hyrule Castle Entrance (West)', 'Agahnims Tower', 'Hyrule Castle Entrance (East)', 'Inverted Pyramid Hole', 'Hyrule Castle Ledge Drop', 'Hyrule Castle Ledge Courtyard Drop']),
        ...
        create_lw_region(player, 'Cave 45 Area', None, ['Flute Boy Bush (South)', 'Cave 45 Inverted Approach', 'Cave 45 NW', 'Cave 45 EC']),
        create_lw_region(player, 'Cave 45 Flute Boy Entry', None, ['Flute Boy Bush (North)', 'Cave 45 NC']),
        create_lw_region(player, 'Cave 45 Ledge', None, ['Cave 45', 'Cave 45 Inverted Leave', 'Cave 45 Ledge Drop']),
        ...
        create_lw_region(player, 'Desert Area', None, ['Aginahs Cave', 'Desert Palace Statue Move', 'Checkerboard Ledge Approach', 'Desert ES']),
        ...
        create_lw_region(player, 'Desert Checkerboard Ledge', None, ['Checkerboard Cave', 'Checkerboard Ledge Leave', 'Checkerboard Ledge Drop']),
        ...
        create_lw_region(player, 'Desert Pass Area', ['Purple Chest'], ['Desert Fairy', '50 Rupee Cave', 'Desert Pass Ladder (South)', 'Desert Pass WS', 'Desert Pass EC', 'Desert Pass Rocks (North)']),
        ...
        create_lw_region(player, 'East Death Mountain (West Top)', None, ['DM Hammer Bridge (West)', 'East Death Mountain WN']),
        create_lw_region(player, 'East Death Mountain (East Top)', None, ['Paradox Cave (Top)', 'DM Hammer Bridge (East)', 'Floating Island Bridge (East)', 'East Death Mountain Spiral Drop', 'East Death Mountain Fairy Drop', 'East Death Mountain Mimic Drop', 'East Death Mountain EN']),
        ...
        create_lw_region(player, 'East Death Mountain (Bottom)', None, ['DM Broken Bridge (East)', 'Paradox Cave (Bottom)', 'Paradox Cave (Middle)', 'Hookshot Fairy', 'Spiral Cave (Bottom)', 'Fairy Ascension Rocks', 'East Death Mountain Teleporter']),
        create_lw_region(player, 'Death Mountain Floating Island (Light World)', ['Floating Island'], ['Floating Island Bridge (West)']),
        create_lw_region(player, 'Death Mountain TR Pegs', None, ['Death Mountain TR Pegs WN', 'TR Pegs Teleporter']),
        ...
        create_dw_region(player, 'Skull Woods Forest', None, ['Skull Woods First Section Hole (East)', 'Skull Woods First Section Hole (West)', 'Skull Woods First Section Hole (North)',
                        'Skull Woods First Section Door', 'Skull Woods Second Section Door (East)', 'Skull Woods Bush Rock (East)', 'Lost Woods East Mirror Spot', 'Skull Woods SE']),
        ...
        create_dw_region(player, 'Circle of Bushes Area', None, ['Circle of Bushes Bush (South)', 'Cave 45 Mirror Spot', 'Circle of Bushes NW', 'Circle of Bushes EC']),
        create_dw_region(player, 'Circle of Bushes Stumpy Entry', None, ['Circle of Bushes Bush (North)', 'Flute Boy Entry Mirror Spot', 'Circle of Bushes NC']),
        ...
        create_dw_region(player, 'Misery Mire Ledge', None, ['Mire Ledge Drop']),
        ...
        create_dw_region(player, 'Dark Death Mountain (West Top)', None, ['Ganons Tower', 'Dark Death Mountain Drop (West)', 'Dark Death Mountain Ladder (North)', 'West Death Mountain (Top) Mirror Spot', 'West Dark Death Mountain EN']),
        create_dw_region(player, 'Dark Death Mountain (West Bottom)', None, ['Spike Cave', 'Dark Death Mountain Fairy', 'Dark Death Mountain Ladder (South)', 'Spectacle Rock Mirror Spot', 'West Dark Death Mountain ES']),
        create_dw_region(player, 'Dark Death Mountain (East Top)', None, ['Superbunny Cave (Top)', 'Hookshot Cave', 'Dark Death Mountain Drop (East)', 'East Death Mountain (West Top) Mirror Spot', 'East Death Mountain (East Top) Mirror Spot', 'East Dark Death Mountain WN', 'East Dark Death Mountain EN']),
        ...
        create_dw_region(player, 'Dark Death Mountain (Left Lip)', None, ['Death Mountain Bridge Mirror Spot', 'East Dark Death Mountain WS']),
