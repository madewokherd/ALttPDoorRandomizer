...
def create_sprite(area_id, kind, tile_x, tile_y, region=None, address=None, fix=False, bonk=False, water=False, embed=False):
...
def init_vanilla_sprites_ow():
    ...
    create_sprite(0x232, EnemySprite.BombRefill1, 0x1A, 0x09, '', 0x09CB73, bonk=True)
    create_sprite(0x232, EnemySprite.SmallHeart, 0x19, 0x12, '', 0x09CB76, bonk=True)
    ...
    create_sprite(0x42, EnemySprite.Faerie, 0x06, 0x16, '', 0x09CBBD, bonk=True)
    ...
    create_sprite(0x51, EnemySprite.Faerie, 0x08, 0x10, '', 0x09CC15, bonk=True)
    create_sprite(0x51, EnemySprite.Faerie, 0x09, 0x10, '', 0x09CC18, bonk=True)
    ...
    create_sprite(0x54, EnemySprite.BombRefill1, 0x05, 0x0B, '', 0x09CC48, bonk=True)
    create_sprite(0x54, EnemySprite.RedRupee, 0x19, 0x0B, '', 0x09CC4B, bonk=True)
    create_sprite(0x54, EnemySprite.Ropa, 0x07, 0x0F, '', 0x09CC4E)
    create_sprite(0x54, EnemySprite.Faerie, 0x0F, 0x0E, '', 0x09CC51, bonk=True)
    ...
    create_sprite(0x55, EnemySprite.BlueRupee, 0x1B, 0x0F, '', 0x09CC67, bonk=True)
    create_sprite(0x55, EnemySprite.Hinox, 0x07, 0x17, '', 0x09CC6A)
    create_sprite(0x55, EnemySprite.Bee, 0x0A, 0x1A, '', 0x09CC6D, bonk=True)
    ...
    create_sprite(0x56, EnemySprite.Bee, 0x04, 0x0E, '', 0x09CC7A, bonk=True)
    ...
    create_sprite(0x5b, EnemySprite.Faerie, 0x17, 0x2A, '', 0x09CCED, bonk=True)
    ...
    create_sprite(0x5e, EnemySprite.Faerie, 0x30, 0x30, '', 0x09CD4F, bonk=True)
    ...
    # Screen6E:
    create_sprite(0x6e, EnemySprite.BlueRupee, 0x0C, 0x08, '', 0x09CDBE, bonk=True)
    create_sprite(0x6e, EnemySprite.Bee, 0x10, 0x09, '', 0x09CDC1, bonk=True)
    create_sprite(0x6e, EnemySprite.Apple, 0x14, 0x0A, '', 0x09CDC4, bonk=True)
    ...
    create_sprite(0x74, EnemySprite.Apple, 0x0E, 0x14, '', 0x09CE35, bonk=True)
    ...
    create_sprite(0x0, EnemySprite.Bee, 0x29, 0x25, '', 0x09CF6A, bonk=True)
    ...
    create_sprite(0x5, EnemySprite.Faerie, 0x34, 0x10, '', 0x09CFB8, bonk=True)
    ...
    # Screen0A_1:
    create_sprite(0xa, EnemySprite.Bee, 0x0E, 0x04, '', 0x09CFDE, bonk=True)
    ...
    create_sprite(0xa, EnemySprite.Apple, 0x19, 0x1A, '', 0x09CFF9, bonk=True)
    # Screen0F_1:
    ...
    create_sprite(0x10, EnemySprite.Apple, 0x07, 0x0C, '', 0x09D016, bonk=True)
    create_sprite(0x10, EnemySprite.LargeMagic, 0x17, 0x0F, '', 0x09D019, bonk=True)
    ...
    create_sprite(0x11, EnemySprite.BombRefill1, 0x08, 0x10, '', 0x09D026, bonk=True)
    ...
    # Screen13_1:
    create_sprite(0x13, EnemySprite.Apple, 0x18, 0x09, '', 0x09D03A, bonk=True)
    ...
    create_sprite(0x15, EnemySprite.Faerie, 0x1B, 0x0F, '', 0x09D057, bonk=True)
    ...
    # Screen18_1:
    create_sprite(0x18, EnemySprite.Faerie, 0x18, 0x0A, '', 0x09D078, bonk=True)
    ...
    create_sprite(0x18, EnemySprite.BlueRupee, 0x36, 0x33, '', 0x09D09C, bonk=True)
    # Screen1A_1:
    create_sprite(0x1a, EnemySprite.BlueGuard, 0x14, 0x0C, '', 0x09D0A0)
    create_sprite(0x1a, EnemySprite.GreenGuard, 0x0C, 0x0E, '', 0x09D0A3)
    create_sprite(0x1a, EnemySprite.Faerie, 0x0D, 0x11, '', 0x09D0A6, bonk=True)
    create_sprite(0x1a, EnemySprite.BlueRupee, 0x17, 0x17, '', 0x09D0A9)
    create_sprite(0x1a, EnemySprite.SmallHeart, 0x0A, 0x18, '', 0x09D0AC, bonk=True)
    ...
    create_sprite(0x1b, EnemySprite.Apple, 0x16, 0x14, '', 0x09D0BC, bonk=True)
    ...
    # Screen1D_1:
    create_sprite(0x1d, EnemySprite.Apple, 0x0B, 0x06, '', 0x09D0DB, bonk=True)
    ...
    # Screen2B_1:
    create_sprite(0x2b, EnemySprite.Faerie, 0x16, 0x0D, '', 0x09D168, bonk=True)
    ...
    # Screen32_1:
    create_sprite(0x32, EnemySprite.SmallHeart, 0x1A, 0x09, '', 0x09D1E3, bonk=True)
    create_sprite(0x32, EnemySprite.BlueGuard, 0x0B, 0x0B, '', 0x09D1E6)
    create_sprite(0x32, EnemySprite.BlueGuard, 0x12, 0x0B, '', 0x09D1E9)
    create_sprite(0x32, EnemySprite.Faerie, 0x19, 0x12, '', 0x09D1EC, bonk=True)
    # Screen33_1:
    ...
    create_sprite(0x90, EnemySprite.Bee, 0x29, 0x25, '', 0x09D2DC, bonk=True)
    ...
    create_sprite(0x95, EnemySprite.Faerie, 0x34, 0x10, '', 0x09D32D, bonk=True)
    ...
    # Screen0A_2:
    create_sprite(0x9a, EnemySprite.Bee, 0x0E, 0x04, '', 0x09D353, bonk=True)
    ...
    create_sprite(0x9a, EnemySprite.Apple, 0x19, 0x1A, '', 0x09D365, bonk=True)
    # Screen0F_2:
    ...
    create_sprite(0xa0, EnemySprite.Apple, 0x07, 0x0C, '', 0x09D382, bonk=True)
    create_sprite(0xa0, EnemySprite.LargeMagic, 0x17, 0x0F, '', 0x09D385, bonk=True)
    ...
    create_sprite(0xa1, EnemySprite.BombRefill1, 0x08, 0x10, '', 0x09D395, bonk=True)
    create_sprite(0xa1, EnemySprite.Cucco, 0x08, 0x17, '', 0x09D398)
    # Screen12_2:
    create_sprite(0xa2, EnemySprite.Faerie, 0x14, 0x0A, '', 0x09D39C, bonk=True)
    ...
    # Screen13_2:
    create_sprite(0xa3, EnemySprite.Bee, 0x18, 0x09, '', 0x09D3A9, bonk=True)
    create_sprite(0xa3, EnemySprite.BombRefill8, 0x07, 0x0C, '', 0x09D3AC, bonk=True)
    ...
    create_sprite(0xa5, EnemySprite.Faerie, 0x1B, 0x0F, '', 0x09D3CF, bonk=True)
    create_sprite(0xa5, EnemySprite.RedSpearGuard, 0x0B, 0x17, '', 0x09D3D2)
    create_sprite(0xa5, EnemySprite.Apple, 0x04, 0x1A, '', 0x09D3D5, bonk=True)
    # Screen16_2:
    ...
    create_sprite(0xa8, EnemySprite.RedRupee, 0x18, 0x0A, '', 0x09D3F6, bonk=True)
    ...
    create_sprite(0xa8, EnemySprite.Bee, 0x36, 0x33, '', 0x09D414, bonk=True)
    # Screen1A_2:
    create_sprite(0xaa, EnemySprite.BlueGuard, 0x0F, 0x08, '', 0x09D418)
    create_sprite(0xaa, EnemySprite.BlueGuard, 0x0C, 0x0E, '', 0x09D41B)
    create_sprite(0xaa, EnemySprite.Faerie, 0x0D, 0x11, '', 0x09D41E, bonk=True)
    create_sprite(0xaa, EnemySprite.SmallHeart, 0x0A, 0x18, '', 0x09D421, bonk=True)
    ...
    create_sprite(0xab, EnemySprite.Apple, 0x16, 0x14, '', 0x09D42B, bonk=True)
    ...
    # Screen1D_2:
    create_sprite(0xad, EnemySprite.Bee, 0x0B, 0x06, '', 0x09D447, bonk=True)
    ...
    create_sprite(0xae, EnemySprite.Faerie, 0x22, 0x37, '', 0x09D48A, bonk=True)
    ...
    create_sprite(0xba, EnemySprite.RedRupee, 0x15, 0x14, '', 0x09D4D7, bonk=True)
    create_sprite(0xba, EnemySprite.RedRupee, 0x0F, 0x18, '', 0x09D4DA, bonk=True)
    # Screen2B_2:
    create_sprite(0xbb, EnemySprite.BlueGuard, 0x08, 0x06, '', 0x09D4DE)
    create_sprite(0xbb, EnemySprite.Faerie, 0x16, 0x0D, '', 0x09D4E1, bonk=True)
    ...
    # Screen2E_2:
    create_sprite(0xbe, EnemySprite.Faerie, 0x0C, 0x09, '', 0x09D502, bonk=True)
    create_sprite(0xbe, EnemySprite.Bee, 0x14, 0x0B, '', 0x09D505, bonk=True)
    ...
    # Screen32_2:
    create_sprite(0xc2, EnemySprite.SmallHeart, 0x1A, 0x09, '', 0x09D55C, bonk=True)
    ...
    create_sprite(0xc2, EnemySprite.BombRefill4, 0x19, 0x12, '', 0x09D568, bonk=True)
